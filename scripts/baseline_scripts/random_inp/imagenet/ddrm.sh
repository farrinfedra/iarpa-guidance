...
exp_root=/home/pandeyk1/coc_results/imagenet/random_in2/baselines/ddrm #the root and the exp_name.
ROOT_DIR=$(pwd)
...
batch_size=1
num_gpus=1
num_workers=1 # Set to 0 for ffhq
...
samples_root=\"task=${deg_file}_lr=${lr}_eta=${eta}_grad-term-weight=${grad_term_weight}_steps=${difussion_steps}_maskprob=${mask_prob}\"
exp_name=\"exp\"
