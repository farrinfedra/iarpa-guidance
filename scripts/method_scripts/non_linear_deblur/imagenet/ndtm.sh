exp_root=/home/pandeyk1/coc_results/imagenet/nl_deblur/dtm/sota1k/ #the root and the exp_name.
ROOT_DIR=$(pwd)
...
echo "Running script for: t-end $t_end, gamma_t: $combine_fn_gamma_t, M: $M and eta: $eta"
...
deg_file=non-linear_deblur # Options: superres, non-linear_deblur, bid_motion_deblur, bid_gaussian_deblur
sigma_y=0.005
